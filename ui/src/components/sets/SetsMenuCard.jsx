...
const SetsMenuCard = (props) => {

    const item = {
        id: Date.now(),
        name: props.name,
        img: `./src/assets/img/sets/${props.img}`,
        price: props.price
    }
    ...
    return (
        <div className="border-2 rounded-3xl overflow-hidden mb-3 p-4 flex flex-col justify-between">
            <div className="">
                <img src={`./src/assets/img/sets/${props.img}`} className="mx-auto" alt={props.name} />
            </div>
